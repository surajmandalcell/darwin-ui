					...
					>
						<div className="w-[320px] bg-card/95 backdrop-blur-xl rounded-xl border border-border shadow-2xl shadow-black/50 overflow-hidden">
							...
							<div className="p-6 flex flex-col items-center text-center">
								...
								>
									A macOS-inspired React component library for building
	...
	const getMenuItems = useCallback((): Record<string, MenuItem[]> => {
		...
		return {
			...
			View: [
				...
				{ label: "", separator: true },
				{
					label: activeWindow?.isMaximized
						? "Exit Full Screen"
						: "Enter Full Screen",
					action: handleZoom,
					shortcut: "⌃⌘F",
			...
			Window: [
				...
				{ label: "", separator: true },
				{
					...
					disabled:
						state.windows.filter((w) => w.isOpen && !w.isMinimized).length ===
						0,
				},
			],
			Help: [
