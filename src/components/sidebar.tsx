						...
						<Tooltip delayDuration={0}>
							<TooltipTrigger asChild>
								<button
									...
									className={cn(
										"group flex w-full items-center rounded-xl text-sm font-medium text-zinc-500 dark:text-zinc-400 transition-all duration-200 ease-out hover:bg-zinc-100 dark:hover:bg-white/10 hover:text-zinc-700 dark:hover:text-zinc-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/50",
