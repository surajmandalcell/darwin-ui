	...
	if (!children) {
		return (
			<button
				...
				onClick={() => onOpenChange(false)}
				className={cn(
					"absolute right-4 top-4 rounded-lg p-1 text-zinc-500 dark:text-zinc-400 hover:text-zinc-700 dark:hover:text-zinc-200 hover:bg-black/5 dark:hover:bg-white/10 transition-all duration-150 outline-none focus-visible:ring-2 focus-visible:ring-blue-500/50 focus-visible:ring-inset",
					className
				)}
			>
				<X className="h-4 w-4" />
