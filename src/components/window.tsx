...
export function Window({ children, title }: WindowProps) {
	return (
		<motion.div
			...
			className="flex h-full w-full flex-col rounded-[var(--radius-lg,0.75rem)] border border-black/10 dark:border-white/10 bg-white/95 dark:bg-zinc-900/95 shadow-lg backdrop-blur-md"
		>
